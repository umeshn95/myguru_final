                          ...
                          <FormControl component="fieldset">
                            ...
                            >
                              <FormControlLabel checked={
                                ...
                                onChange={() => submit(test.discreption && test.discreption.map((e) => e.selectNumber.a),
                              ...
                              <FormControlLabel checked={
                                ...
                                disabled={oneOption === typeOfTest && backup && backup.find((p) => p.oneQuizeCorrect.id === e.id ? true : false)}
                                onChange={() => submit(test.discreption && test.discreption.map((e) => e.selectNumber.b),
                              ...
                              <FormControlLabel checked={
                                ...
                                disabled={oneOption === typeOfTest && backup && backup.find((p) => p.oneQuizeCorrect.id === e.id ? true : false)}
                                onChange={() =>
                                  submit(test.discreption && test.discreption.map((e) => e.selectNumber.c),
                              ...
                              {e.d ? <FormControlLabel checked={
                                ...
                                disabled={oneOption === typeOfTest && backup && backup.find((p) => p.oneQuizeCorrect.id === e.id ? true : false)}
                                onChange={() =>
                                  submit(test.discreption && test.discreption.map((e) => e.selectNumber.d),
                              ...
                              {e.e ? <FormControlLabel checked={
                                ...
                                disabled={oneOption === typeOfTest && backup && backup.find((p) => p.oneQuizeCorrect.id === e.id ? true : false)}
                                onChange={() =>
                                  submit(test.discreption && test.discreption.map((e) => e.selectNumber.e),
